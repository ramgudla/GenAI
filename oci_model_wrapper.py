...
class OCIModelWrapper:
    def __init__(self):
        ...
        self.ora23ai_table_name = "MY_DEMO"
        self.chroma_persist_directory = "MY_DEMO"
    ...
    def persist_ora23ai_vs(self):
        ...
        pdf = PdfReader('pdf-docs/budget_speech.pdf')
        ...
        username = "testuser"
        password = "testuser"
        dsn = "ramgudla.xxxx:1521/FREEPDB1"
    ...
    def persist_chroma_vs(self):
        # Load documents
        loader = PyPDFLoader("pdf-docs/budget_speech.pdf")
